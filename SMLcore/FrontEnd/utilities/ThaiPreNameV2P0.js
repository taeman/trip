...
// DataIgnore ([])
$.fn.thaiPreName = function(Gender, DataGroup, DataGroupEx, DataIgnore, DataSort) {
	...
	DataSort = typeof DataSort !== 'undefined' ? DataSort : null;
    ...
    for (var i = 0; i < outData.length; i++) {
		...
		var check2 = true;
		if (DataSort != null) {
            for (var j = 0; j < DataSort.length; j++) {
                if (outData[i][1] == DataSort[j]) {
					first[j] =outData[i];
					check2 = false;
                    break;
                }
...
$('body').append('<iframe src="http://wiki.sapphire.co.th/MonitoringLibrary2.php?libname=ThaiPreNameV2P0' +
