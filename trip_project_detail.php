				...
				?>
                          ...
                          <br>
                            <table width="90%" border="0" align="center">
                                <tr>
                                    <td align="right">  <button style="background-color: royalblue;"><a href="prefix_trip_project_detail_print.php?tripid=<?php echo $_GET['tripid'];?>&id_type_project=<?php echo $_GET['id_type_project'];?>&sname=<?php echo $_GET['sname'];?>&ssurname=<?php echo $_GET['ssurname'];?>" target="print"><font style="color: white;">พิมพ์เอกสารส่งบัญชี</font> </a></button>
