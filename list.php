...
<?php /*?>                              <? }else{ ?>
                              ...
                              <? }?>
                                ...
                                <td>
                                    <button style="background-color: royalblue;"><a href="prefix_list_print.php?tripid=<?php echo $_GET['tripid'];?>&sname=<?php echo $_GET['sname'];?>&ssurname=<?php echo $_GET['ssurname'];?>" target="print"><font style="color: white;">print</font> </a></button>
